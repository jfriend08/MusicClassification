...
\begin{subfigure}{.5\textwidth}
  \centering
  \includegraphics[width=.4\linewidth]{../fig/svcSplit1_svcNewVLAD200Iter.png}
  \caption{Baseline method 5: Accuracy from search space}
  \label{fig:sub1}
\end{subfigure}%
\begin{subfigure}{.5\textwidth}
  \centering
  \includegraphics[width=.4\linewidth]{../fig/svcFlatSplit1_ScatterHPMFCCNewVLAD.png}
  \caption{New feature extraction method 3: Accuracy from search space}
  \label{fig:sub2}
\end{subfigure}
...
\begin{figure}[!ht]
  \centering
    \reflectbox{%
      \includegraphics[width=0.5\textwidth]{../fig/HP_deltas1.png}}
...
\begin{figure}[!ht]
  \centering
    \reflectbox{%
      \includegraphics[width=0.5\textwidth]{../fig/histogram_n1.png}}
