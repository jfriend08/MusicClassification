...
\begin{abstract}
Our project presents a series of feature extraction methods that ultimately extracts series of meaningful signals and thus provide robust distinguishment among different genres.
\end{abstract}
