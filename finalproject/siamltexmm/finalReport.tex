...
From Table I. we can see various experiment results with different classifiers and different ways of featuer extraction.  Although our experiment results didn't reach the result on top of list, we emphasize on robustness.  That is, in general our prediction accuracies are concentrated around 70\% to 75\% and we hit 79\% often.
